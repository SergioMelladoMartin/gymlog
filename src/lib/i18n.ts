...
const ES: Dict = {
  ...
  'day.volume': 'volumen',
  'day.startToday': 'Empieza tu entreno abajo',
  ...
  // Empty states
  'empty.workout.title': 'Toca empezar',
  'empty.workout.body': 'Añade el primer ejercicio cuando estés listo.',
...
const EN: Dict = {
  ...
  'day.volume': 'volume',
  'day.startToday': 'Start your workout below',
  ...
  'empty.workout.title': 'Let’s start',
  'empty.workout.body': 'Add your first exercise when you are ready.',
