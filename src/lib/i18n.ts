...
const ES: Dict = {
  ...
  'workout.confirmRemoveExercise': '¿Quitar "{name}" del entreno de hoy? Se borrarán todas sus series.',
  'workout.removeFromDay': 'Quitar del día',
  'workout.sets': 'sets',
...
const EN: Dict = {
  ...
  'workout.confirmRemoveExercise': 'Remove "{name}" from today\'s workout? All its sets will be deleted.',
  'workout.removeFromDay': 'Remove from day',
  'workout.sets': 'sets',
  'workout.series': 'sets',
  'workout.serie': 'set',
