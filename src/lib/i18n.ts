...
const ES: Dict = {
  ...
  'workout.removeExercise': 'Quitar del día',
  'workout.confirmRemoveExercise': '¿Quitar {name} del día? Se borrarán sus series registradas.',
  'workout.sets': 'sets',
...
const EN: Dict = {
  ...
  'workout.removeExercise': 'Remove from day',
  'workout.confirmRemoveExercise': 'Remove {name} from today? Its logged sets will be deleted.',
  'workout.sets': 'sets',
  'workout.series': 'sets',
  'workout.serie': 'set',
